...
dos quais essa produção depende \citep{spera_agricultural_2017,gomes_agricultural_2019}.
...
não sustenta de forma ótima. Em escala global, cerca de metade da terra agricolamente adequada está
sob uso agropecuário, e na América do Sul só cerca de 23\% da terra potencialmente disponível para
lavoura é cultivada \citep[pp.~3--4, 10]{schneider_global_2022}. Em segundo lugar, o clima regional já
está mudando: a transição entre a Amazônia oriental e o Cerrado registra as tendências de aquecimento e
ressecamento mais intensas da América do Sul tropical desde 1981, com pressão sobre a fronteira agrícola
\citep[pp.~1, 6]{marengo_increased_2022}. Projeções indicam que a viabilidade estabelecida sob o clima
de hoje pode contrair ou migrar até meados do século \citep[p.~11]{souza_climate-driven_2026}, e esse
deslocamento não precisa ser uniforme entre municípios e segmentos de uso da terra.
...
\begin{itemize}
  ...
  \item \textbf{QP2 --- Potencial versus uso atual.} Onde o uso atual da terra diverge do potencial modelado? Isto é, onde a terra está sendo subutilizada ou seu
...
conversão de pastagem em lavoura já documentado nacionalmente \citep{caballero_transformation_2023}. \textbf{QP3:} a
...
A dissertação segue, após essa introdução, pelos capítulos de Materiais, Metodologia,
Resultados e Discussão \& Conclusão, com o capítulo de Metodologia definindo QP1/QP2/QP3,
