...
GO~e~DF em sete zonas agroambientais que abrangem cinco vocações comparativas --- dois planaltos
de cultivo, um planalto de pecuária, duas planícies quentes com vocação fotovoltaica, uma baixada
ripária com vocação para aquicultura e um planalto alto e íngreme, com alta concentração de carbono,
cujo melhor uso é a conservação.

\textbf{QP2:} as zonas, construídas apenas com variáveis biofísicas, reproduzem a geografia observada
do território sem nunca usar a cobertura da terra como entrada. A vegetação nativa alcança 78\% do
planalto de conservação. As lavouras, por sua vez, ocupam terras sistematicamente mais viáveis do que a
média territorial (a viabilidade média da soja é 0,93 nos pixels efetivamente cultivados, contra 0,77 em
toda a área apta ao cultivo). Persiste um hiato relevante entre potencial e uso atual: cerca de 48\% do
...
conjunto de modelos (concordância entre modelos $\geq$ 0,92). Três segmentos estão expostos: a
