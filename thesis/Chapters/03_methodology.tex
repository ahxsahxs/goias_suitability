...
FAO (\emph{Framework for Land Evaluation}; Food and Agriculture Organization)
\citep{FAO1976,Sys1991}. Ele é implementado
...
\S\ref{sec:feature-eng}. Um classificador de floresta aleatória é então treinado em modo
probabilístico sobre esses pontos de presença e de fundo, ao longo do conjunto padronizado de
atributos \citep{Valavi2021}; a superfície resultante, construída inteiramente a partir do uso
realizado, é comparada à superfície baseada em conhecimento pelo $\kappa$ de Cohen
\citep{Cohen1960}. O objetivo é, portanto, verificar se duas abordagens independentes para o
