...
%% TODO cabe uma citação sobre a FAO aqui
...
O número de zonas é selecionado em $k = 2,\dots,20$ pela silhueta média \citep{Rousseeuw1987}, pelo
...
estabilidade bem mais fraca em $k=7$ (ARI $= 0{,}687$). 
...
robustez ao viés, e sua deficiência quanto à redução estatística de escala, é documentada
...
como $\mathrm{ETP} \propto R_a\,(T_{\text{méd}} + 17{,}8)\sqrt{T_{\max} - T_{\min}}$, na razão entre ETP
futura e histórica a radiação extraterrestre $R_a$ e os termos constantes se anulam, dependendo
apenas da temperatura média \citep{Hargreaves1985,Hargreaves2003}. A aridez resulta, então, da precipitação e da ETP futuras.
