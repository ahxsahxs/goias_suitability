...
índice de Davies--Bouldin \citep{Davies1979}, pela estatística de \emph{gap} \citep{Ikotun2025} e
pela estabilidade de subamostras (índice de Rand ajustado, \emph{bootstrap}), que em conjunto
indicam $k = 10$. Neste território fracamente agrupado a silhueta é quase plana ao longo de todo
o intervalo (0,17--0,19) e o Davies--Bouldin não decide sozinho, por ficar próximo em $k=7$, $8$
e $10$; o argumento decisivo é a estabilidade: $k = 10$ tem a silhueta mais alta do intervalo
($0{,}187$) \textbf{e} é o k mais estável sob subamostragem (ARI $= 0{,}962$), contra uma
estabilidade bem mais fraca em $k=7$ (ARI $= 0{,}687$). Um \emph{sweep} estendido a
$k = 2,\dots,20$ sobre a mesma amostra confirma que $k=10$ não é um artefato de faixa truncada: a
silhueta cai para $0{,}177$ em $k=11$ e nunca volta a superar $0{,}187$ até $k=20$.
...
rigoroso --- a concordância média territorial é $0{,}999$ (Figura~\ref{fig:ensemble-agreement} do
Anexo), com uma pequena bolsa de concordância mais baixa ($\approx 0{,}99$) no extremo sudeste do
território. O corolário é que a \emph{superfície} de concordância tem, em si, pouco contraste
espacial para revelar: ela documenta que o sinal do CMIP6 é robusto ao GCM escolhido, mais do que
localiza \emph{onde} a incerteza entre modelos se concentra.
