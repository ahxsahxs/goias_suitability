...
suitability surfaces for the seven segments and a partition into \textbf{ten zones} with
distinct comparative vocations, among them three regions whose best vocation is conservation. The
zones, built solely from biophysical variables, reproduce with fidelity the observed geography of land use 
(soybean AUC of 0.871). They also reveal a relevant gap
...
change is modest,
yet directionally robust (inter-model agreement $\approx$ 1.0 in the most rigorous test): it
affects mainly
