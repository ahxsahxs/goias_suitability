...
$-19{,}50^\circ$ a $-12{,}39^\circ$. O artefato mesclado (\texttt{data/mart/malha\_municipal.gpkg}) é
...
filosofia de zero \emph{upload} (\S\ref{sec:cost}) ---, com as geometrias simplificadas em memória antes
de compor qualquer requisição ao Earth Engine. Para a fase de uso atual da terra, as próprias 247
