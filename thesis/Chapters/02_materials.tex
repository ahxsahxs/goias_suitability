...
A geometria da área de interesse é derivada de um produto global de limites administrativos, restrito
a GO~e~DF e dissolvido em um polígono único que se estende aproximadamente da longitude $-53{,}25^\circ$
a $-45{,}90^\circ$ e da latitude $-19{,}50^\circ$ a $-12{,}39^\circ$. Para a fase de uso atual da terra,
as unidades municipais são obtidas do segundo nível administrativo do mesmo produto.
...
\section{Plataforma de computação e filosofia de custo}
...
ao mercado (Global Accessibility to Cities). Completam o conjunto a cobertura genérica da terra (ESA
WorldCover), as áreas protegidas (WDPA), o carbono de biomassa acima do solo (Spawn \emph{et al.}) e o
clima futuro (NASA NEX-GDDP-CMIP6, \citealp{Thrasher2022}).
As entradas de \textbf{uso atual e validação} (Tabela~\ref{tab:src-realized} do Anexo) são as unidades municipais de segundo
nível do GAUL, as classificações anuais de uso da terra do MapBiomas \citep{Souza2020} e os produtos de
