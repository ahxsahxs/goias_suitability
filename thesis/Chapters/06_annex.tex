...
\textbf{Pecuária} (apenas exclusão) & Precipitação anual (mm) & 0,22 & intervalar & 700, 1000, 2000, 2600 \\
 & Duração da estação seca (meses) & 0,22 & decrescente & 4, 8 \\
 & Umidade do solo (mm) & 0,22 & crescente & 20, 120 \\
 & Declive ($^\circ$) & 0,18 & decrescente & 8,53, 17,7 \\
 & Carbono orgânico do solo (g/kg) & 0,16 & crescente & 4, 18 \\
...
\textbf{Geração fotovoltaica} (disponível) & Radiação solar (W/m$^2$) & 0,34 & crescente & 180, 240 \\
 & Declive ($^\circ$) & 0,22 & decrescente & 2,86, 8,53 \\
 & Log do tempo de viagem à cidade & 0,20 & decrescente & 3, 6 \\
 & Distância à água (m) & 0,12 & crescente & 200, 3000 \\
 & Componente norte da orientação & 0,12 & crescente & $-0{,}3$, 0,5 \\
\bottomrule
\end{longtable}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{fig_4_11.png}
\caption{Parcela de cada fator na variância espacial da viabilidade de cada segmento.
Terreno e solo dominam as culturas (fatores climáticos $\approx$ 0); umidade do solo e
carbono orgânico governam a pecuária; conectividade e rugosidade governam a conservação.}
