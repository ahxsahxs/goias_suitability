...
\begin{itemize}
  ...
  \item \textbf{Descompasso de escala clima--solo.} As entradas climáticas ($\approx$4,6~km,
    ...
    ($\approx$9--11~km, mais de 2$\times$ pior), e o AgERA5 sequer está no catálogo oficial. Que o
    clima atue como comporta, e não como fonte de estrutura fina, já foi demonstrado
    quantitativamente (\S\ref{sec:atlas-present}, mapa de magnitude na
    Figura~\ref{fig:scale-mismatch}): a resolução nominal do clima é enganosa apenas em
    aparência, pois a estrutura fina do atlas nunca dependeu dela. Essa leitura, porém, simplifica
    a estrutura real do modelo se aplicada ingenuamente por \emph{prefixo de
