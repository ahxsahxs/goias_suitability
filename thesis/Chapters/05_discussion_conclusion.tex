...
terra boa de terra ruim é o solo e o terreno, não o clima.
...
\begin{itemize}
  ...
  \item \textbf{Solo de um único produto global.} A decomposição por fator mostra que, com o
    clima quase uniforme, solo e terreno carregam a maior parte da discriminação espacial; o
    atlas herda, portanto, a acurácia do OpenLandMap a 250~m, que o desenho sem \emph{upload}
    impede de validar contra um levantamento nacional de solos.
