...
\begin{itemize}
  ...
  \item \textbf{Descompasso de escala clima--solo.} As entradas climáticas ($\approx$4~km) são
    bem mais grosseiras que solo e terreno (250~m); como o clima atua como comporta e não como
    fonte de estrutura fina, o impacto prático é pequeno, mas a resolução nominal é enganosa.
