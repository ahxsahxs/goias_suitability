...
cultivo (Zonas~0 e~5, a primeira com maior viabilidade de culturas e cultivo atual mais denso);
um planalto alto e argiloso mais adequado à pecuária extensiva (Zona~2); duas planícies quentes
e de alta irradiância voltadas à geração fotovoltaica (Zonas~1 e~4, esta última terra marginal);
uma baixada ripária voltada à aquicultura (Zona~3); e um planalto alto, íngreme e rico em
carbono onde a viabilidade de culturas colapsa e a conservação é o melhor uso (Zona~6, com
...
\begin{itemize}
  ...
  % TODO acho que vale fazer uma analise de impacto dos fatores de maneira mais elaborada, ao inves de comparar clima com terreno+solo, fazer uma analise agrupada por tema levando em consideração a estrutura do modelo e da padronização das variaveis
