...
viabilidade atual para os sete segmentos e uma partição em \textbf{sete zonas} com vocações
...
usar a cobertura como insumo (AUC da soja de 0,83). Elas também revelam um hiato relevante entre
...
é modesta,
porém direcionalmente robusta (concordância entre modelos $\geq$ 0,92): atinge sobretudo a
