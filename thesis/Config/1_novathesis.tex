...
\newcommand{\imsDegree}{mcsig}        % mgi, megi, mdsaa, mddm, ...
\newcommand{\imsSpecialization}{cdg} % bi, gcbi, ...

% --------------------------------------------------
% NOVA IMS – Cover options
%
% \imsDegree:
%   mgi   – Master in Information Management
%   megi  – Master in Statistics and Information Management
%   mdsaa – Master in Data Science and Advanced Analytics
%   mddm  – Master in Data-Driven Marketing
%   mcsig – Master in Geographic Information Systems and Science
%   dgi   – PhD in Information Management
%   mgt   – Master in Geospatial Technologies
%
% \imsSpecialization (depends on the course):
%   mgi:   bi, gcbi, gsti, gsi, mi, td
%   megi:  agi, agr, mrcrm
%   mdsaa: ba, ds
%   mddm:  dma, ds4m, mi, mrcrm
%   mcsig: csig, cdg
%   dgi:   main       (without specialization)
%   mgt:   main       (no specialization, only in EN)
%
% Language:
%   The cover page is generated in PT or EN depending on the document's language.
% --------------------------------------------------
